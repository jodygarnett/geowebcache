...
/**
 * Represents a submitted request as a Geowebcache Job. Each Geowebcache Job is a collection of tasks that
 * can be handled in parallel (using available threads).
 * 
 * Jobs may be complete, running, or not started yet.
 */
public class JobObject { // TODO: rename Job
    ...
    /**
     * This is the MIME format from {@link SeedRequest#getMimeFormat()}.
     * @return MIME format
     */
